...
<body>
  ...
  <h3><img src="images\usericon.png" width="20" height="20"><a href="appliedapplications">Applied Applications</a></h3>
  <h3><img src="images\recruitericon.png" width="20" height="20"><a href="sorteddata.jsp">View Jobs</a></h3>
 ...
 <% UserBean ub=(UserBean)session.getAttribute("userbean");%>
  ...
  <% 
  ArrayList<JobProperties> alist=(ArrayList<JobProperties>)request.getAttribute("sortedjobs"); 
  if(alist!=null){
...
while(i.hasNext()){
  ...
  <a id="btn" href="applyjob?applyUsingSlno=<%=jp.getSlno()%>">Apply</a>
  </div>
  </section>
  <%
  }
