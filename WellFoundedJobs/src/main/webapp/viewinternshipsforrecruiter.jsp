...
<html lang="en">
 ...
 <h3><img src="images\usericon.png" width="20" height="20"><a href="receivedapplicants?recruiterCompany=<%=rb.getCompanyName()%>">Received Applications</a></h3>
  ...
  <h3><img src="images\adminicon.webp" width="20" height="20"><a href="viewinternshipsforrecruiter">View Internships</a></h3>
...
while(i.hasNext()){
  ...
  <div class="btn">
  <a href="editinternship?editUsingSlno=<%=data.getSlno()%>">Edit</a>
  <a href="deleteinternship?deleteUsingSlno=<%=data.getSlno()%>">Delete</a>
  </div>
  </section>
  <%
  }
