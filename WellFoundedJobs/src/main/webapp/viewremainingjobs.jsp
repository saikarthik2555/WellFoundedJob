<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,jobportal.entity.JobProperties" %>
<!DOCTYPE html>
<html lang="en">
 <head>
  <meta charset="UTF-8">
...
<h3><img src="images\adminicon.webp" width="20" height="20"><a href="postintership.html">Post Internship</a></h3>
...
while(i.hasNext()){
  ...
  %>
  <div class="btn">
  <a href="editjob?editUsingSlno=<%=slno%>">Edit</a>
  <a href="deletejob?deleteUsingSlno=<%=slno%>">Delete</a>
  </div>
  </section>
  <%
  }
